...
<template>
  <div class="beciencia-home">
    ...
    <main>
      ...
      <!-- Newsletter pendiente: conservar este bloque para activarlo cuando Be Ciencia tenga lista su propuesta y su tratamiento de suscripciones. -->
    ...
    <footer class="bc-footer bc-wrap"><span>© {{ new Date().getFullYear() }} Be Ciencia</span><span>Academia de química</span><div class="bc-footer-links"><RouterLink to="/aviso-legal">Aviso legal</RouterLink><RouterLink to="/privacidad">Privacidad</RouterLink><RouterLink to="/cookies">Cookies</RouterLink><RouterLink to="/terminos">Términos</RouterLink></div><RouterLink to="/login">Acceso alumnos</RouterLink></footer>
